...
<script type="text/javascript">
   function update(){
	   if($("#file").val()!=''){ // 파일이 첨부가 된 경우...
  		 ...
  		 document.form1.action="<c:url value='/memberUpdate.do'/>?mode=update"; // mode=add는 파일업로드 제외 fadd는 포함.
...
<div class="container">
  ...
  <div class="panel panel-default">
    ...
    <form id="form1" name="form1" class="form-horizontal" method="post">
      <input type="hidden" name="num" value="${vo.num}"/> <!-- 회원정보 수정을 위해서 -->
